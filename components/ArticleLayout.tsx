...
export function ArticleLayout({
  ...
  return (
    <ArticleAudioProvider audioRef={audioRef} timestamps={paragraphTimestamps}>
      <article
        className="article-print mx-auto max-w-3xl px-4 py-6"
        dir="rtl"
      ...
      >
        ...
        <div className="space-y-8">
          ...
          {imageUrl && (
            <section className="overflow-hidden rounded-xl border border-stone-200 print:break-inside-avoid">
          ...
          <section className="font-urdu text-lg leading-relaxed text-stone-800 prose prose-stone max-w-none prose-p:mb-0 rtl:prose-headings:text-right">
            {children}
          </section>
        </div>
      </article>
